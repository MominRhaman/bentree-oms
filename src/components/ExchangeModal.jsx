...
const ExchangeModal = ({ order, onClose, onConfirm, inventory }) => {
    ...
    // --- LOGIC: Subtract Old Delivery Charge (Customer pays for previous shipping) ---
    ...
    // This reflects the total revenue generated by this order lifecycle
    ...
    const handleSubmit = async (e) => {
        ...
        onConfirm(order.id, {
            ...
            discountType: discountType === 'amount' ? 'Fixed' : 'Percent',
            discountValue: rawDiscount,
            discount: actualDiscountAmount,
            
            // FIX: Delivery Charge is now the SUM of old + new
            ...
            note: `Exchange. (New Val ${newProductValue} - Old Val ${oldProductValue}) + New Del ${newDeliveryCost} = ${finalAdjustment}`
        });
        onClose();
    };
