...
const CancelledOrders = ({ orders, onUpdate }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <h2 className="text-xl font-bold text-slate-800">Cancelled Orders</h2>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-x-auto">
                <table className="w-full text-sm text-left min-w-[700px]">
                    ...
                    <tbody>
                        {filtered.map(order => (
                            <tr key={order.id} className="border-b hover:bg-slate-50 bg-red-50 bg-opacity-30">
                                ...
                                <td className="p-3">
                                    <button
                                        ...
                                        className="flex items-center gap-1 bg-emerald-100 text-emerald-700 px-3 py-1 rounded text-xs font-bold hover:bg-emerald-200"
                                    >
                                        <RotateCcw size={14} /> Reconfirm
                                    </button>
                                </td>
                            </tr>
                        ))}
